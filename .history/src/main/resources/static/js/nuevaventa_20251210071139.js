...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Función para imprimir (llamada desde el botón del modal)
  async function imprimirComprobante() {
    ...
    try {
      ...
      // Descargar
      const numeroComprobante = document.querySelector('.numero-comp').textContent;
      pdf.save(`comprobante-${numeroComprobante}.pdf`);
      
    } catch (error) {
      console.error('Error al generar PDF:', error);
      alert('Error al generar el PDF. Se abrirá el diálogo de impresión.');
      window.print();
    }
  }
  // ==========================================
